...
<div className="flex flex-row w-full">
  <div className='hidden lg:flex flex-col justify-between bg-[#e5adfb] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
    <div className="flex items-center justify-start space-x-3">
      ...
      <a href="#" className="font-medium text-xl">Payme</a>
    </div>
    ...
    <p className="font-medium">© 2024 Payme By Swarup</p>
  </div>
  <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
    ...
    <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
      <div className="flex flex-col space-y-2 text-center">
        ...
        <p className="text-md md:text-xl">Sign up or log in to Pay anytime anywhere!</p>
      </div>
